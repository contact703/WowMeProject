...
export default function ReceivedStoryPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-pink-900 text-white p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-8 flex gap-4 justify-center">
          <Link
            href="/submit"
            className="bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 rounded-lg font-medium hover:opacity-90 transition"
          >
            ✨ Share Another Story
          </Link>
          <Link
